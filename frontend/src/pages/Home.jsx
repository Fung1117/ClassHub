        ...
        <Flex justify="center" align="center" vertical style={{ width: '100%' }}>
            <Flex gap="middle" align="center" justify="center" style={{ width: '100%', }}>
                ...
                <Flex justify="center" align="center" vertical gap={20} style={{ height: 650, width: '30%' }}>
                    <Card hoverable cover={<img src={SoonClass} height={200} />} style={{ height: 320, width: '100%' }} actions={[<RightOutlined key="setting" />]}>
                        <Meta
                            title="If you have a class soon, find all the details—classroom, teacher's message, Zoom link, and materials—all in one place."
                        />
                    </Card>
                    <Card hoverable cover={<div style={{ display: 'flex', justifyContent: 'center' }}> <img src={TimeTable} style={{width: 200, height: 200, objectFit: 'cover'}}/></div> } style={{ height: 320, width: '100%' }} actions={[<RightOutlined key="setting" />]}>
                        <Meta
